...
public class MainActivity extends Activity {
	...
	/**Checks whether the user can login or not.
	 * @param IOException failed to set nursemanager.
	 */
	public void login(View view) throws IOException {
		...
		if (username.equals("") || password.equals("")) {
			...
			if (click.isChecked()) {
				...
				Nurse nurse= new Nurse(username, password, this.getApplicationContext().getFilesDir(), 
						"patient.txt");
				...
				Physician physician= new Physician(username, password, 
						this.getApplicationContext().getFilesDir(), "patient.txt");
